...
messages.en = Object.assign(messages.en, store.state.text_details_messages.en)
messages.ta = Object.assign(messages.ta, store.state.text_details_messages.ta)
messages.te = Object.assign(messages.te, store.state.text_details_messages.te)
